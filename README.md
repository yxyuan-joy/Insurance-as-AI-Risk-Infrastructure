...
```bash
# From the directory extracted from the anonymous repository archive:
...
Research inputs are distributed through the companion [anonymous dataset](https://anonymous-hf.com/a/v3b4fjkrkwi9/).
